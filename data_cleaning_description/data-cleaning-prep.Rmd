...
CA1_avg <- CA1_splice |>
  mutate(Ozone = round(CA1_splice$Ozone, 3), PM2.5 = round(CA1_splice$PM2.5, 1),
         CO = round(CA1_splice$CO, 1), NO2 = round(CA1_splice$NO2, 0),
         SO2 = round(CA1_splice$SO2, 0), PM10 = round(CA1_splice$PM10, 0))

write_csv(CA1_avg, "CA1_avg.csv")
